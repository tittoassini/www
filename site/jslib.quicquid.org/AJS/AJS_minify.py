...
class AjsAnalyzer:
    ...
    def getFnCode(self, fn_name, caller=None):
        ...
        elif fn_name not in ['listeners', 'Class', 'BASE_URL', 'ajaxErrorHandler']:
...
class AjsComposer:
    ...
    def __init__(self, fn_list, analyzer):
        ...
        req = ['_unloadListeners', 'createDOM', '_createDomShortcuts', 'log', 'addEventListener', 'queryArguments']
