...
function runTest() {
	...
	console.log("TESTRUNNER config.ajaxSettings = ",$.ajaxSettings);
	if (typeof ($.ajaxSettings.type) == undefined) console.error("TESTRUNNER BAD: ",$.ajaxSettings);
...
function reset() {
	...
	console.log("TESTRUNNER $.ajaxSettings = ",$.ajaxSettings);
	if (typeof ($.ajaxSettings.type) == undefined) console.error("TESTRUNNER BAD: ",$.ajaxSettings);
}
