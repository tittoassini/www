$.quid2.view = {
	...
	init : function(state, env, names) {
		...
		function evInput(elem) {
			...
			env.evalStringWithType(txt, function(expr) {
				showWithType(env, elem, expr);
			});
		};
		...
		function newInput(elem) {
			...
			var ac = new quid2.ui.AutoComplete.Basic(names.vs, inputElem.get(0), true, true);
